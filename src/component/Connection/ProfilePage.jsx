...
// Update theme constants for more consistent black styling
const theme = {
  background: 'bg-black',
  card: {
    base: 'bg-gradient-to-b from-gray-900/40 to-gray-800/20',
    hover: 'hover:from-gray-800/40 hover:to-gray-900/20',
  ...
  button: {
    primary: 'bg-gradient-to-r from-gray-800/80 to-gray-900/80 hover:from-gray-700/80 hover:to-gray-800/80',
    secondary: 'bg-gradient-to-r from-gray-900/50 to-black/50 hover:from-gray-800/50 hover:to-gray-900/50'
  }
};

// Update the navigation header to be more stylish
const ProfileNavBar = ({ activeTab, setActiveTab, onBack }) => (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex items-center h-16">
        <motion.button
          whileHover={{ x: -4 }}
          onClick={onBack}
          className="mr-6 px-3 py-1.5 rounded-lg bg-gray-900/50 border border-gray-800/50 
                    text-gray-400 hover:text-gray-200 transition-colors flex items-center gap-2"
        >
          <ArrowLeft size={16} />
          <span>Back</span>
        </motion.button>

        <div className="flex items-center bg-gray-900/30 rounded-lg p-1 border border-gray-800/50">
...
// Update the UnderConstruction component styling
    ...
    >
      <div className="text-center">
        ...
        <div className="flex justify-center">
          <span className="inline-flex items-center px-4 py-2 rounded-lg bg-gray-800/50 
...
const UserProfilePage = () => {
  ...
  // Fix animation flicker by using layoutId
  ...
  return (
    <div className={`min-h-screen ${theme.background}`}>
      {/* Add the NavBar */}
      <ProfileNavBar activeTab={activeTab} setActiveTab={setActiveTab} onBack={() => navigate(-1)} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                  ...
                  >
                    ...
                    bg-black
                      ...
                      rounded-2xl overflow-hidden shadow-lg mb-6
                      backdrop-blur-sm
                    `}>
                      ...
                      <div className="relative py-8 px-6">
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                          {/* Profile picture */}
                          <div className="w-36 h-36 rounded-full overflow-hidden ring-4 ring-gray-900/50 bg-black shadow-xl mb-4">
                          ...
                          {/* Profession */}
                          {profile.profession && (
                            <div className="bg-gray-900/40 px-4 py-1.5 rounded-full mb-4 border border-gray-700/50">
                      ...
                      <div className="p-6">
                        <div className="space-y-4">
                          {profile.location && (
                            <div className="flex items-center space-x-3 p-2 rounded-lg bg-black border border-indigo-500/10">
                          ...
                          {profile.email && !restricted && (
                            <div className="flex items-center space-x-3 p-2 rounded-lg bg-black border border-gray-800 ">
                              <div className="p-2 rounded-full bg-indigo-500/10">
                  ...
                  >
                    {/* Main Profile Card */}
                    <div className={`bg-black border border-gray-800  rounded-2xl p-6 shadow-lg mb-6`}>
                      {restricted ? (
