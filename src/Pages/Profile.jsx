...
import TaskCard from '../component/Tasks/TaskComponent';
import { useQuery } from '@tanstack/react-query';
import TaskComponent from '../component/Tasks/TaskComponent';
...
const Profile = () => {
    ...
    return (
        <div className={`min-h-screen bg-black p-6 md:p-8 transition-colors duration-300 relative overflow-hidden`}>
            {/* Add noise overlay */}
            ...
            <motion.div
                ...
                className="max-w-8xl mx-auto pt-6 pb-8 px-6 md:px-8"
            >
                ...
                {activeTab === 'profile' && (
                    <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-12 gap-2 mb-8">
                        {/* Profile Info Card */}
                        <div className={`${glassCard} rounded-2xl p-4 col-span-1 lg:col-span-3 hover:shadow-white/5`}>
                        ...
                        <div className='col-span-12 lg:col-span-6 grid grid-cols-2 gap-2 max-h-[500px]'>
                        ...
                        <div className='col-span-1'>
                            ...
                            <div className={`${glassCard} col-span-1 rounded-2xl p-4 hover:shadow-white/5`}>
                                <div className="flex justify-between items-center mb-6">
                                    <h2 className={`text-xl font-bold ${headingClass}`}>Recent Activity</h2>
                                </div>
                                
                                <div className="flex flex-col gap-2 h-[calc(100%-4rem)] overflow-y-auto custom-scrollbar pr-1">
                                    {/* Activity items */}
                                    <div className="flex items-start gap-3 p-3 rounded-lg bg-[#1A1A1A]/40 border border-[#292929]">
                                        <div className="p-2 rounded-full bg-purple-500/10 mt-0.5">
                                            <CheckCircle className="w-4 h-4 text-purple-400" />
                                        </div>
                                        <div>
                                            <p className={`${textClass} text-sm`}>You completed <span className="font-medium">Project Setup</span> task</p>
                                            <p className={`${subTextClass} text-xs mt-1`}>Today, 2:30 PM</p>
                                        </div>
                                    </div>
                                    
                                    <div className="flex items-start gap-3 p-3 rounded-lg bg-[#1A1A1A]/40 border border-[#292929]">
                                        <div className="p-2 rounded-full bg-blue-500/10 mt-0.5">
                                            <MessageCircle className="w-4 h-4 text-blue-400" />
                                        </div>
                                        <div>
                                            <p className={`${textClass} text-sm`}>John commented on <span className="font-medium">API Integration</span></p>
                                            <p className={`${subTextClass} text-xs mt-1`}>Yesterday</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-span-1 lg:col-span-3">
                            <div className={`${glassCard} rounded-2xl p-0 h-full hover:shadow-white/5`}>
